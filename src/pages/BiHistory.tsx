    ...
    <div className="bi-glass-theme space-y-8 pb-16 relative">
      <div className="space-y-8">
        ...
        <Card className="bi-glass-hero bi-glass-reflection text-white border-none shadow-xl relative overflow-hidden">
          ...
          <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
            <div>
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                <Badge className="bi-glass-pill text-white font-bold border-none text-[11px] tracking-wider uppercase">
                  Business Intelligence Estratégico
                </Badge>
                <Badge className="bg-amber-400 text-amber-950 font-black border-none text-[11px] shadow-sm">
                  Série Temporal Completa
                </Badge>
                <Badge className="bg-emerald-500/80 text-white font-semibold border-none text-[11px] shadow-sm">
              ...
              <CardDescription className="text-white/85 text-sm max-w-3xl mt-1.5 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-2.5 shrink-0">
              {/* Seletor de Período em Vidro Translúcido */}
              <div className="bi-glass-pill rounded-xl p-1 flex items-center gap-1.5 shadow-sm">
                <Filter className="w-3.5 h-3.5 text-white/80 ml-2" />
              ...
              <Button
                ...
                variant="secondary"
                className="bg-white text-[#1c2394] hover:bg-white/90 font-bold text-xs gap-1.5 shadow-lg border-none h-10 px-4 hover:scale-105 transition-transform cursor-pointer"
              >
          ...
          {/* Quick Nav Anchors em Vidro */}
          <div className="px-6 pb-4 pt-1 flex items-center gap-2 overflow-x-auto relative z-10 border-t border-white/10 text-xs">
            <span className="text-white/70 font-semibold text-[11px] uppercase tracking-wider shrink-0 mr-1">
              Navegação Rápida:
            </span>
            <button
              onClick={() => scrollToSection("secao-kpis")}
              className="px-3 py-1.5 rounded-lg bi-glass-pill text-white font-medium transition cursor-pointer shrink-0 hover:scale-105"
            >
              🎯 KPIs Executivos
            </button>
            <button
        ...
        {top3Faturamento.length > 0 && (
          <Card 
            ...
            className="bi-glass-amber bi-glass-reflection border border-amber-300/80 dark:border-amber-900/50 shadow-md overflow-hidden relative transition-all"
          >
