      ...
      <Card className="bg-gradient-to-br from-[#0f1236] via-[#1c2394] to-[#de392a] text-white border-none shadow-lg relative overflow-hidden">
        ...
        <CardHeader className="flex flex-row items-center justify-between relative z-10">
          <div>
            ...
            <CardTitle className="text-2xl font-black text-white mt-1">Fluxo de Caixa</CardTitle>
            <p className="text-xs text-white/70 mt-1">Análise detalhada da saúde financeira mensal da escola.</p>
          </div>
          <Button 
